...
- **^K** is the command palette: new, open, delete, rename, move to folder, extract to new note, merge into note, reading view, find in note, bookmark, open vault, help, settings, quit.

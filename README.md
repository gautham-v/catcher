...
- Mouse works: click, drag to select, scroll. A selection waits for **^C** — the drag itself never touches the clipboard, so you can type or paste over what you highlighted.

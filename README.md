...
One note on screen at a time. **^K** opens the palette — every note listed by filename, fuzzy-searched by filename first, then title, then body, plus commands (new, open, delete, rename file, preview, shortcuts, settings, quit).

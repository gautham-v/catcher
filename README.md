...
- **^K** is the command palette: new, new from template, insert template, open, delete, rename, move to folder, trash, extract to new note, merge into note, reading view, find in note, bookmark, open vault, help, settings, quit.

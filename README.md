...
- **^K** is the command palette: new, open, delete, rename, move to folder, trash, reading view, find in note, bookmark, open vault, help, settings, quit.
